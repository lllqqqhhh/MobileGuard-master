...
public class VersionUpdateUtils {
    ...
    private static final int MESSAGE_JOSN_ERROR = 103;
    ...
    public void getCloudVersion(){
        try{
            ...
            if (execute.getStatusLine().getStatusCode()==200){
                ...
                String resulu = EntityUtils.toString(httpEntity,"utf-8");
                JSONObject jsonObject = new JSONObject(resulu);
            ...
            handler.sendEmptyMessage(MESSAGE_JOSN_ERROR);
        }
    }
    private void showUpdateDialog(final VersionEntity versionEntity){
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setMessage("检查到有新版本："+versionEntity.versionCode);
